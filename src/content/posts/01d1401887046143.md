---
title: "epbf与用户态的数据读写_BPFmaps"
date: "2026-05-15"
updated: "2026-05-15T01:39:37.317Z"
category: "koo1se"
tags: ["eBPF", "Linux", "Kernel"]
---

# epbf与用户态的数据读写/BPF maps
...
![图片](/img/koo1se/01d1401887046143/1760263673276-79103be0-0348-4a35-9ff2-37bd34ea18be-882068.webp)

查看对应的输出通道信息sudo cat /sys/kernel/debug/tracing/trace\_pipe

![图片](/img/koo1se/01d1401887046143/1760263706477-42693631-9af1-4f42-b350-8c32fc2b9966-741992.webp)

## 2.Perf Buffer

**监听系统调用 **<code>**execve**</code>** 的执行事件**（即当一个进程执行新程序时触发），并把相关信息（PID、进程名、执行的命令路径等）发送到用户空间。
...
不是说perf和ring是被动回调和主动推送 为什么都是用xx\_\_poll()在循环中?
...
perf\_buffer\_\_poll(pb, 100) 这一步其实是调用了内核的 `poll()` 系统调用，意思是：
...
> 更新: 2025-10-12 19:12:31  
> 原文: <https://www.yuque.com/kugua-4bekq/koo1se/lo1gnm1c70f8sxc0>