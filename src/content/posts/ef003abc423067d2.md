...
category: "projects"
tags: ["Go", "Wails", "逆向", "PE", "Windows"]
---

![appicon](/img/projects/ef003abc423067d2/appicon.webp)

## GBFR PE Patch Tool

Granblue Fantasy: Relink（碧蓝幻想：Relink）补丁工具，包含静态 PE 补丁和运行时内存读写两部分功能。

> 项目地址：[https://github.com/BitterG/GBFR-PE-Patch-Tool](https://github.com/BitterG/GBFR-PE-Patch-Tool)
